...
@testset "Vortex model possible flows" begin include("vortexmodel/possibleflows.jl") end
@testset "Vortex dynamics" begin
    include("vortexmodel/vortexnearcylinder.jl")
    include("vortexmodel/corotatingvortices.jl")
end
@testset "Vortex shedding" begin include("vortexmodel/vortexshedding.jl") end
@testset "Impulse" begin include("vortexmodel/cylinderimpulse.jl") end
